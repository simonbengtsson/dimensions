...
/**
 * Class for customizing player. Skins, character name etc for further use.
 * 
 * @author kimegenvall
 * 
 */
public class CustomizeScreen extends AbstractMenuScreen {
	...
	public void init() {
		final TextButton name = new TextButton("Choose your hero",
				getButtonStyle());
		...
		save.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				// Do saving stuff
				g = new GameScreen(game, LevelHandler.getInstance()
