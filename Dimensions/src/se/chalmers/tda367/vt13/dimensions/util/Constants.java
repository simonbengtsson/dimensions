...
public class Constants {
	...
	public static final String DIMENSIONCHANGEPOWERUP_IMAGE = "";
	public static final String DIMENSIONCHANGEPOWERUP_SOUND = "";
	public static final String SLOWPOWERUP_IMAGE = "";
